...
import { buscarRelatorioInventarioBitola, listarBitolasSeparacao, reimprimirEtiqueta } from "@/services/api";
...
function ModalReimpressao({ codigoBarras, vias, onClose, onSuccess }: ModalReimpressaoProps) {
  ...
  async function handleConfirmar() {
    ...
    setLoading(true);
    try {
      await reimprimirEtiqueta(codigoBarras, undefined, motivo.trim());
...
/* ── Botão de reimprimir (abre o modal) ── */

function BotaoReimprimir({ codigoBarras, vias, onSuccess }: { codigoBarras: string; vias: number; onSuccess: () => void }) {
